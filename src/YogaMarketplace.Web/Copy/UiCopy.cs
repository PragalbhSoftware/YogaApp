...
public static class UiCopy
{
    ...
    public const string BlockingSlot = "Blocking this slot.";
    public const string BlockUpdateFailed = "Could not block this slot. Try again.";
    public const string NoOwnedSlots = "No slots in this range.";
    public const string NoOwnedSlotsHint = "Open times for this mode show up in the current week.";
    public const string InstructorWeekKicker = "Your week";
    ...
    public const string NoInstructorBookingsHint = "Paid requests show up here. Try another status if you are looking for an older session.";
    public const string AcceptHint = "Accept keeps the session. Decline refunds the customer and frees the slot.";
    public const string CompleteHint = "The customer can leave one rating after you mark it complete.";
    public const string UpdatingRequest = "Updating this request.";
    public const string RequestUpdateFailed = "Could not update this request. Try again.";
